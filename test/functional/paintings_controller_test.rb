...
class PaintingsControllerTest < ActionController::TestCase
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post :create, painting: { image: @painting.image, medium: @painting.medium, style: @painting.style, title: @painting.title, year: @painting.year }
    end
  ...
  test "should update painting" do
    put :update, id: @painting, painting: { image: @painting.image, medium: @painting.medium, style: @painting.style, title: @painting.title, year: @painting.year }
    assert_redirected_to painting_path(assigns(:painting))
  end
